...
# 我们的项目结构和教程不太一样，所以对build-elf.rs做了一点修改
# ../os/build.rs -> ../os/os/build.rs
# ../ci-user -> ../../ci-user
if 5 >= chapter >= 4:
    os.system("cp overwrite/build-elf.rs ../os/os/build.rs")
elif chapter < 4:
    os.system("cp overwrite/build-bin.rs ../os/os/build.rs")

# 我们的Makefile和教程不太一样，这里避免替换。
# if chapter <= 5:
